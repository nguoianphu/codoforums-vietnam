    ...
    <div class="row">
        ...
        <div class="col-lg-12 codo_mobile_top_container">
            ...
            <div class="codo_icon_header d-block d-sm-none  d-none d-sm-block d-md-none container" style="padding-top: 0">

                <div onclick="CODOF.toggleTopicsAndCategories()" class="col-md-6 col-12"><i class="icon-books" title="{_t("Categories")}"></i>
